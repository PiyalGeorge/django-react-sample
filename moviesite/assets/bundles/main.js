...
var _listing = __webpack_require__(48);
...
var _movielisting = __webpack_require__(49);

var _movielisting2 = _interopRequireDefault(_movielisting);

var _movieListActions = __webpack_require__(50);
...
var List = (_dec = (0, _reactRedux.connect)(function (store) {
	return {
	...
	_createClass(List, [{
		...
		value: function componentWillMount() {
			this.props.dispatch((0, _movieListActions.fetchMovies)());
		}
	}, {
		key: 'render',
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'a',
										{ href: 'movielist.html', className: 'list' },
										_react2.default.createElement('i', { className: 'ion-ios-list-outline ' })
									),
									_react2.default.createElement(
										'a',
										{ href: 'moviegridfw.html', className: 'grid' },
										_react2.default.createElement('i', { className: 'ion-grid active' })
									)
								),
								_react2.default.createElement(
									'div',
									{ className: 'flex-wrap-movielist mv-grid-fw' },
									movieList.map(function (movies, i) {
										return _react2.default.createElement(_movielisting2.default, { key: i, data: movies });
									})
								),
								_react2.default.createElement(
									'div',
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							" Read more ",
							_react2.default.createElement("i", { className: "ion-android-arrow-dropright" }),
							" "
						)
					),
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"p",
							{ className: "rate" },
							_react2.default.createElement("i", { className: "ion-android-star" }),
							_react2.default.createElement(
								"span",
								null,
...
function fetchMovies() {
	return function (dispatch) {
		_axios2.default.get("http://127.0.0.1:8000/api/v1/movies/").then(function (response) {
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(14), __webpack_require__(88)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__isPromise_js__ = __webpack_require__(101);
...
var _movieListReducers = __webpack_require__(103);

var _movieListReducers2 = _interopRequireDefault(_movieListReducers);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = (0, _redux.combineReducers)({
	movieList: _movieListReducers2.default
});
...
function reducer() {
	...
	switch (action.type) {
		case "FETCH_MOVIES_FULFILLED":
			{
				return _extends({}, state, { fetching: false, fetched: true, movieList: action.payload });
			}
